...
#[openapi(
    ...
    components(schemas(
        ...
        v1::records::typed_data::RecordKind,
        v1::records::typed_data::TypedRecordKind,
        v1::records::typed_data::OpaqueRecordKind,
        v1::records::typed_data::ARecordData,
        v1::records::typed_data::AaaaRecordData,
        v1::records::typed_data::NsRecordData,
        v1::records::typed_data::PtrRecordData,
        v1::records::typed_data::CnameRecordData,
        v1::records::typed_data::DnameRecordData,
        v1::records::typed_data::MxRecordData,
        v1::records::typed_data::TxtRecordData,
        v1::records::typed_data::SrvRecordData,
        v1::records::typed_data::NaptrRecordData,
        v1::records::typed_data::SshfpRecordData,
        v1::records::typed_data::LocRecordData,
        v1::records::typed_data::HinfoRecordData,
        v1::records::typed_data::DsRecordData,
        v1::records::typed_data::DnskeyRecordData,
        v1::records::typed_data::CdsRecordData,
        v1::records::typed_data::CdnskeyRecordData,
        v1::records::typed_data::CsyncRecordData,
        v1::records::typed_data::CaaRecordData,
        v1::records::typed_data::TlsaRecordData,
        v1::records::typed_data::SmimeaRecordData,
        v1::records::typed_data::SvcbRecordData,
        v1::records::typed_data::HttpsRecordData,
        v1::records::typed_data::UriRecordData,
        v1::records::typed_data::OpenpgpkeyRecordData,
        // Host contacts
