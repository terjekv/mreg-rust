...
use super::{
    ...
    hosts::{
        ...
        list_ip_addresses_for_hosts_in_state, list_ip_addresses_in_state, move_ip_address_in_state,
...
impl<'tx> TxNetworkStore for MemTxStorage<'tx> {
    ...
    fn delete_excluded_range(&self, network: &CidrValue, range_id: Uuid) -> Result<(), AppError> {
